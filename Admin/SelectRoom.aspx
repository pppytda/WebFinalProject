                ...
                <td rowspan="2" bgcolor="#33495E" bordercolor="#33495E" valign="top">
                    ...
                    <table border="0">
                        <td>
                            ...
                            <br />
                            &nbsp;&nbsp;<asp:ImageButton ID="btCancelRoom" runat="server" ImageUrl="~/img/btCancelRoom.gif" Height="34px" Width="203px" OnClick="btCancelRoom_Click" />
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="btBookSche" runat="server" ImageUrl="~/img/btBookSchedule.gif" Height="34px" Width="210px" OnClick="btBookSche_Click" />
                            <br />
                            ...
                            <br />
                            &nbsp;&nbsp;<asp:ImageButton ID="btAddBook" runat="server" ImageUrl="~/img/btAddBook.gif" Height="34px" Width="210px" OnClick="btAddBook_Click" />
                            <br />
                            &nbsp;&nbsp;<asp:ImageButton ID="btCheckRoom" runat="server" ImageUrl="~/img/btCheckRoom.gif" Height="34px" Width="210px" OnClick="btCheckRoom_Click" />
                            <br />
                            &nbsp;&nbsp;<asp:ImageButton ID="btCheckStatus" runat="server" ImageUrl="~/img/btCheckProblem.gif" Height="34px" Width="210px" />
                        </td>
                    </table>
                </td>    
